        ...
        <div className="py-1 border-b-2 px-4">
            <div className=" mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center justify-between gap-2 pr-2 border-2 rounded-md w-[40%]">
                    <input type="text" placeholder="Search username..." className="px-2 py-1 rounded-md" />
                    <span className="flex text-xl gap-1"><IoIosClose title="clear" className="text-white hidden bg-red-600 rounded-full hover:scale-125 transition-all" /> <IoIosSearch title="search" className="hover:scale-125 transition-all" /></span>
                </div>
